//1703066
//Q2. Show an OpenGL Program which will show three triangles aligned in y axis with overlapping with yellow color in red background using 3 VBO and 3 VAO.
#include "glad.h"
#include "glfw3.h"
